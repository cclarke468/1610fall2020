    ...
    public class NavMeshAssetManager : ScriptableSingleton<NavMeshAssetManager>
    {
        ...
        static string GetAndEnsureTargetPath(NavMeshSurface surface)
        {
            ...
            else
            {
                ...
                if (isPartOfPrefab && !string.IsNullOrEmpty(prefabStage.prefabAssetPath)) //CHANGED from prefabStage.assetPath, may cause errors!
                {
                    var prefabDirectoryName = Path.GetDirectoryName(prefabStage.prefabAssetPath); //CHANGED from prefabStage.assetPath, may cause errors!
